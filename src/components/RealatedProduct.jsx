...
const RealatedProduct = ({productData}) => {
   ...
   const related=products.filter((item)=>item.category ===productData.category) 
  ...
  return (
    <div className='border-t-[1px]  border-[#D9D9D9]'>   
      ...
      <div class="flex items-center justify-center"><button onClick={()=>setShowmore(show+4)} class="pb-92px mt-[32px] cursor-pointer w-[245px] px-78px border border-[#B88E2F] py-12px font-semibold text-[16px] text-[#B88E2F] text-center">Show more</button></div>
    </div>
  )
}
