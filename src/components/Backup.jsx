        ...
        <div className="flex gap-[40px] flex-col w-[50%]">
          <div className="flex overflow-hidden gap-[24px] ">
            <div className="w-[372px] h-[486px] flex-shrink-0 relative items-center justify-center">
              ...
              <button
                onClick={() =>
                  goToSlide((currentIndexSlide + 1) % slides.length)
                }
                className=" w-[48px] cursor-pointer h-[48px] shadow-lg rounded-full bg-white flex items-center justify-center absolute  right-[-20px] top-1/2 "
              >
