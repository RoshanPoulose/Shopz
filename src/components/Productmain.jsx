...
const Productmain = ({ productData }) => {
  const { addToCart, addToCompare} = useContext(ShopContext); 
  ...
  const handleAddToCart=()=>{
    ...
    setToast(`${productData.title} Added to Cart !  🛒 `) 
  }

  const handleCompare=()=>{
    addToCompare(productData.id);
    setToast(`${productData.title} is add compare !  🔍 `) 
  } 
          ...
          <div className="flex gap-[22px] flex-col">
            ...
            <div className=" flex gap-[18px]">
              ...
              <button
                ...
                className="py-17px px-58px justify-between flex items-center border-[1px] px-[15px] border-black rounded-[10px]"
              >
                Add to Cart
              </button>
        ...
        <div className="flex flex-col gap-[40px]">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="text-[#9f9f9f] flex items-center">
              ...
              <div className="text-[#9f9f9f] text-[16px] ml-4">
                {productData.tags?.map((item, idx) => (
                  <span>
                    {item}
                    {idx < productData.tags.length - 1 && ","} 
                  </span>
                ))}
              </div>
            </div>
